...
pub const RENDEZVOUS_SERVERS: &[&str] = &["168.138.67.89"];
pub const RS_PUB_KEY: &str = "RdpLLp3bDV3Rk9u5bysyebpTvqR1za8DdyeLloZEAWU=";
pub const API_SERVER: &str = "http://168.138.67.89:21114";
